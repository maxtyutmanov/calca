        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LedgerOperationId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationMembers", x => new { x.OperationId, x.UserId, x.Side });
                    table.ForeignKey(
                        name: "FK_OperationMembers_LedgerOperations_LedgerOperationId",
                        column: x => x.LedgerOperationId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationMembers_LedgerOperationId",
                schema: "accounting",
                table: "OperationMembers",
                column: "LedgerOperationId");
